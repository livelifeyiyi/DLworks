...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, pos_weight=None, token_type_ids=None, attention_mask=None, position_ids=None, head_mask=None):
        ...
        if pos_weight is not None:
            embedding_output = embedding_output * torch.unsqueeze(pos_weight, 2)  # embedding_output.dot(pos_weight)
