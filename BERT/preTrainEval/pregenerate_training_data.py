...
>>>>>>> 166dd4bfac6c60b27bdb2782601c84f65254a35c
                instance = {
                    "tokens": tokens,
...
def main():
    ...
    parser.add_argument('--train_corpus', default='../data/demo.txt', type=Path)
    ...
    parser.add_argument("--do_basic_tokenize", default=False, help="Whether do basic tokenize")
    parser.add_argument("--do_whole_word_mask", default=True, action="store_true",
    ...
    tokenizer = BertTokenizer.from_pretrained(args.bert_model, do_lower_case=args.do_lower_case, do_basic_tokenize=args.do_basic_tokenize)
