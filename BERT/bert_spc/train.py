...
from .data_utils import Tokenizer4Bert, ABSADataset, ABSADataset_sentence_pair
...
def main():
    ...
    parser.add_argument('--model_name', default='bert_spc', type=str, help='bert-spc or bert-sentence-pair')  # bert_spc
    ...
    parser.add_argument('--valset_ratio', default=0.2, type=float, help='set ratio between 0 and 1 for validation support')
    parser.add_argument("--do_eval", default=False, action='store_true', help="Whether to evaluate the model.")
